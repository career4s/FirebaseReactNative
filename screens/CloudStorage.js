...
const CloudStorage = ({navigation}) => {
  ...
  return (
    <View>
      <Text>cloudStorage</Text>
      <TouchableOpacity rounded style={{marginBottom: 10}} onPress={() => navigation.goBack()}><Text>--BACK--</Text></TouchableOpacity>
      <TouchableOpacity rounded style={{marginBottom: 10}} onPress={uploadImage}><Text>Upload Image</Text></TouchableOpacity>
      <TouchableOpacity rounded style={{marginBottom: 10}} onPress={getAllImages}><Text>Get Image Library</Text></TouchableOpacity> 
